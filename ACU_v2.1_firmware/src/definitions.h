...
#define SKIP_PNEUMATIC_CHECK true
#define SKIP_PRESSURE_CHECK1 true
#define SKIP_IGNITION_CHECK true
#define SKIP_PRESSURE_FRONT_CHECK true
#define SKIP_PRESSURE_REAR_CHECK true
#define SKIP_PRESSURE_CHECK2 true
